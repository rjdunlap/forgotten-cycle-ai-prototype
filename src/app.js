import { MAX_WARMTH, buyUpgrade, canReset, createGameState, getScavengeTime, getWarmthFound, resetCycle, runTick } from "./game.js";
const els = {
    cycle: requiredElement("#cycle"),
    progressBar: requiredElement("#progressBar"),
    progressText: requiredElement("#progressText"),
    rate: requiredElement("#rate"),
    resetButton: requiredElement("#resetButton"),
    upgradeButton: requiredElement("#upgradeButton"),
    workButton: requiredElement("#workButton"),
    memories: requiredElement("#memories"),
    upgrades: requiredElement("#upgrades"),
